        ...
        <Stack w={{base: "90vw", xl: "80vw"}} align="center" mt={16} spacing={8}>
            ...
            <Flex gap={4} flexDir={{base: "column", md: "row"}}>
                ...
                <Flex gap={2}>
                    <Menu>
                        <MenuButton
                            data-cy={"region-filter-menu-button"}
                            as={Button}
                        ...
                        <MenuList minW="0" w={"170px"} onClick={handleRegionChange} data-cy={"region-filter-menu"}>
                    ...
                    <Button h={14} onClick={handleSortChange} data-cy={"sort-button"}>
                        <FaSort/>
                    </Button>
                </Flex>
            </Flex>
